...
/** Skeleton matched to Departments unified card layout — Admin source of truth. */
export function DepartmentsManagementSkeleton() {
  return (
    <div className={UNIFIED_CARD_CLASS}>
      ...
      <div className={`${TABLE_HEAD_ROW_CLASS} px-6 py-3.5`}>
        <div className="flex gap-8">
          <div className={cn("h-3.5 w-16 animate-pulse rounded", SKELETON_BG_MEDIUM)} />
          <div className={cn("h-3.5 w-16 animate-pulse rounded", SKELETON_BG_MEDIUM)} />
        </div>
      </div>
