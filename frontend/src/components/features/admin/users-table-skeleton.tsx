...
/** Skeleton matched to Users unified card layout — Academic Years source of truth. */
      ...
      <div className={`divide-y ${SKELETON_DIVIDE_CLASS}`}>
        {Array.from({ length: SKELETON_ROW_COUNT }).map((_, i) => (
          <div key={i} className="flex gap-8 px-6 py-4">
            <div className={cn("h-4 w-40 animate-pulse rounded", SKELETON_BG_SUBTLE)} />
            ...
            <div className={cn("h-4 w-16 animate-pulse rounded", SKELETON_BG_SUBTLE)} />
