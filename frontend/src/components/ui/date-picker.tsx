      ...
      <Popover open={open} onOpenChange={(o) => {
        ...
        <PopoverTrigger asChild>
          <Button
            ...
            id={id}
            className={cn(
              "h-9 w-full cursor-pointer justify-between rounded-lg border border-border/80 bg-transparent text-left font-normal text-foreground shadow-xs transition-[color,box-shadow] hover:bg-muted/[0.06] focus-visible:outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-[invalid=true]:border-destructive/80 aria-[invalid=true]:ring-destructive/10 [&>span]:line-clamp-1 [&>span]:flex [&>span]:items-center [&>span]:gap-2",
