  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(TR_MODAL, POPUP_MOBILE_MAX_W, POPUP_MOBILE_MAX_H, "bg-background fixed top-[50%] left-[50%] z-50 grid cursor-default w-full translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto p-6 outline-none sm:max-w-lg", POPUP_BORDER, POPUP_ROUNDED_MODAL, POPUP_SHADOW, className)}
        {...props}
      >
        {children}
        {showCloseButton && (
