...
import { LAYOUT_BORDER_MAIN } from "@/config/design";
...
export function SidebarHeader({ collapsed }: SidebarHeaderProps) {
  return (
    <div
      className={`flex h-16 shrink-0 items-center border-b border-r bg-sidebar transition-[width] duration-[280ms] ease-[cubic-bezier(0.32,0.72,0,1)] ${LAYOUT_BORDER_MAIN} ${
        collapsed
